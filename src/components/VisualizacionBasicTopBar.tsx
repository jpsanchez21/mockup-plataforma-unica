...
interface VisualizacionBasicTopBarProps {
...
const VisualizacionBasicTopBar: React.FC<VisualizacionBasicTopBarProps> = ({ currentPage = 'dashboard', onGoToInterventions, onGoHome, onLogout }) => {
  return (
...
export default VisualizacionBasicTopBar;
