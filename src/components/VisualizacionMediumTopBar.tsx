...
interface VisualizacionMediumTopBarProps {
...
const VisualizacionMediumTopBar: React.FC<VisualizacionMediumTopBarProps> = ({ currentPage = 'dashboard', onGoToInterventions, onGoHome, onLogout }) => {
  return (
...
export default VisualizacionMediumTopBar;
