...
const VisualizacionMediumInterventionsPage: React.FC<Props> = ({ onOpenIntervention, onBack, initialTab = 'activas' }) => {
...
export default VisualizacionMediumInterventionsPage;
