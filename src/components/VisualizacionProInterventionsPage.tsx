...
const VisualizacionProInterventionsPage: React.FC<Props> = ({ onOpenIntervention, onBack, initialTab = 'activas' }) => {
  ...
  // === HISTORICAS VIEW (SKANMONITOR FULL CLONE) ===
  return (
...
export default VisualizacionProInterventionsPage;
