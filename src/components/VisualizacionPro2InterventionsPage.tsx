...
const VisualizacionPro2InterventionsPage: React.FC<Props> = ({ onOpenIntervention, onBack, initialTab = 'activas' }) => {
          ...
          <div className="flex-1 w-full max-w-7xl mx-auto px-8 pt-6 flex flex-col z-10 relative">
             <div className="flex justify-between items-start mb-6 relative w-full h-[70px]">
                <div className="flex flex-col gap-3 relative z-20">
                    <button
                      onClick={() => { setTab('historicas'); setSelectedId(null); }}
               ...
               <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-1 mt-2">
                     <div className="flex gap-4">
                        <div className="flex flex-col gap-1 w-[160px]">
                           ...
                           <div className="relative">
                              <select
                                 ...
                                 value={filterTorre}
                                 onChange={(e) => { setFilterTorre(e.target.value); setFilterPozo('Todos'); }}
                              >
                        ...
                        <div className="flex flex-col gap-1 w-[160px]">
                           <label className="text-[10px] font-bold uppercase text-white/80 tracking-widests pl-1">Pozo</label>
                           <div className="relative">
                              <select
                                 className="w-full bg-[#111] border border-white/20 text-white rounded px-3 py-1.5 text-[11px] font-bold appearance-none outline-none"
                                 value={filterPozo}
...
export default VisualizacionPro2InterventionsPage;
